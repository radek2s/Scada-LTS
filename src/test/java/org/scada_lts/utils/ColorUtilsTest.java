...
public class ColorUtilsTest {
	...
	public void test() throws InvalidArgumentException {
		...
		Assert.assertTrue(ColorUtils.toHex(colorSnow).equalsIgnoreCase(SNOW_HEX));

		Color shortHexColor = ColorUtils.toColor(COLOR_SHORT_HEX);
		Assert.assertTrue(ColorUtils.toHex(shortHexColor).equalsIgnoreCase(COLOR_FULL_HEX));

		Color fullHexColor = ColorUtils.toColor(COLOR_FULL_HEX);
		Assert.assertTrue(ColorUtils.toHex(fullHexColor).equalsIgnoreCase(COLOR_FULL_HEX));
	}
