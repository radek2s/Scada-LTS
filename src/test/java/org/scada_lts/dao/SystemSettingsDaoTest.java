...
public class SystemSettingsDaoTest extends TestDAO {
	...
	public void valueTest() {
		...
		Assert.assertTrue(result.equals(SETTING_VALUE));
		...
		Assert.assertTrue(result.equals(DEFAULT_VALUE));
	...
	public void databaseTest() {
		...
		Assert.assertTrue(sizeWithRecords > 0);
		Assert.assertTrue(sizeWithRecords >= emptySize);
		...
		Assert.assertTrue(reportInstanceDAO.getReportInstance(ID_FOR_CHECK_RESULT) == null);
	}
}
