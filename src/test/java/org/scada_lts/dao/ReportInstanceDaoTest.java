...
public class ReportInstanceDaoTest extends TestDAO {
	...
	public void testReportInstanceDAO() {
		...
		Assert.assertTrue(reportInstanceSelect.getId() == firstId);
		Assert.assertTrue(reportInstanceSelect.getUserId() == USER_ID);
		Assert.assertTrue(reportInstanceSelect.getName().equals(NAME));
		Assert.assertTrue(reportInstanceSelect.getIncludeEvents() == INCLUDE_EVENTS);
		Assert.assertTrue(reportInstanceSelect.isIncludeUserComments() == INCLUDE_USER_COMMENT);
		Assert.assertTrue(reportInstanceSelect.getReportStartTime() == REPORT_START_TIME);
		Assert.assertTrue(reportInstanceSelect.getReportEndTime() == REPORT_END_TIME);
		Assert.assertTrue(reportInstanceSelect.getRunStartTime() == RUN_START_TIME);
		Assert.assertTrue(reportInstanceSelect.getRunEndTime() == RUN_END_TIME);
		Assert.assertTrue(reportInstanceSelect.getRecordCount() == RECORD_COUNT);
		Assert.assertTrue(reportInstanceSelect.isPreventPurge() == PREVENT_PURGE);
		...
		//Check size
		Assert.assertTrue(reportInstancesList.size() == LIST_SIZE);
		//Check IDs
		Assert.assertTrue(reportInstancesList.get(0).getId() == firstId);
		Assert.assertTrue(reportInstancesList.get(1).getId() == secondId);
		...
		Assert.assertTrue(selectUpdateReportInstance.getId() == updateTimeReportInstance.getId());
		Assert.assertTrue(selectUpdateReportInstance.getUserId() == updateTimeReportInstance.getUserId());
		Assert.assertTrue(selectUpdateReportInstance.getReportStartTime() == updateTimeReportInstance.getReportStartTime());
		Assert.assertTrue(selectUpdateReportInstance.getReportEndTime() == updateTimeReportInstance.getReportEndTime());
		Assert.assertTrue(selectUpdateReportInstance.getRunStartTime() == updateTimeReportInstance.getRunStartTime());
		Assert.assertTrue(selectUpdateReportInstance.getRunEndTime() == updateTimeReportInstance.getRunEndTime());
		Assert.assertTrue(selectUpdateReportInstance.getRecordCount() == updateTimeReportInstance.getRecordCount());
		...
		Assert.assertTrue(selectUpdateReportInstance.getId() == firstId);
		Assert.assertTrue(selectUpdateReportInstance.isPreventPurge() == UPDATE_PREVENT_PURGE);
		...
		Assert.assertTrue(reportInstancesList.size() == 0);
		Assert.assertTrue(reportInstanceDAO.getReportInstance(secondId) == null);
	}
	...
	public void testReportInstancePointDAO() {
		...
		Assert.assertTrue(reportPointInfoList.size()==LIST_SIZE);
		Assert.assertTrue(reportPointInfoList.get(0).getReportPointId() == firstId);
		Assert.assertTrue(reportPointInfoList.get(0).getDeviceName().equals(DATA_SOURCE_NAME));
		Assert.assertTrue(reportPointInfoList.get(0).getPointName().equals(POINT_NAME));
		Assert.assertTrue(reportPointInfoList.get(0).getDataType() == DATA_TYPE);
		Assert.assertTrue(reportPointInfoList.get(1).getReportPointId() == secondId);
		Assert.assertTrue(reportPointInfoList.get(1).getDeviceName().equals(SECOND_DATA_SOURCE_NAME));
		Assert.assertTrue(reportPointInfoList.get(1).getPointName().equals(SECOND_POINT_NAME));
		Assert.assertTrue(reportPointInfoList.get(1).getDataType() == SECOND_DATA_TYPE);
	}
	...
	public void testReportInstanceUserCommentDAO() {
		...
		Assert.assertTrue(reportUserCommentList.size() == 1);
		Assert.assertTrue(reportUserCommentList.get(0).getUsername().equals("fName"));
		Assert.assertTrue(reportUserCommentList.get(0).getCommentType() == 1);
		Assert.assertTrue(reportUserCommentList.get(0).getComment().equals("fCom"));
	}
}
