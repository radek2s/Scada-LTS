...
//		//Check list size
//		Assert.assertTrue(pointEventDetectorList.size() == LIST_SIZE);
//		//Check IDs
//		Assert.assertTrue(pointEventDetectorList.get(0).getId() == firstId);
//		Assert.assertTrue(pointEventDetectorList.get(1).getId() == secondId);
//		//Check update
//		Assert.assertTrue(pointEventDetectorList.get(0).getXid().equals(UPDATE_XID));
//		Assert.assertTrue(pointEventDetectorList.get(0).getAlias().equals(UPDATE_ALIAS));
//		Assert.assertTrue(pointEventDetectorList.get(0).getAlarmLevel() == UPDATE_ALARM_LEVEL);
//		Assert.assertTrue(pointEventDetectorList.get(0).getLimit() == UPDATE_STATE_LIMIT);
//		Assert.assertTrue(pointEventDetectorList.get(0).getDuration() == UPDATE_DURATION);
//		Assert.assertTrue(pointEventDetectorList.get(0).getDurationType() == UPDATE_DURATION_TYPE);
//		Assert.assertTrue(pointEventDetectorList.get(0).isBinaryState() == UPDATE_BINARY_STATE);
//		Assert.assertTrue(pointEventDetectorList.get(0).getMultistateState() == UPDATE_MULTISTATE_STATE);
//		Assert.assertTrue(pointEventDetectorList.get(0).getChangeCount() == UPDATE_CHANGE_COUNT);
//		Assert.assertTrue(pointEventDetectorList.get(0).getAlphanumericState().equals(UPDATE_ALPHANUMERIC_STATE));
//		Assert.assertTrue(pointEventDetectorList.get(0).getWeight() == UPDATE_WEIGHT);
//
...
//		Assert.assertTrue(pointEventDetectorDAO.getPointEventDetectors(dataPoint).size() == 1);
	}
}
