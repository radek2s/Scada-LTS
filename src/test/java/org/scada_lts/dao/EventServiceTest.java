...
public class EventServiceTest extends TestDAO {
	...
	public void saveEvent() {
		...
		Assert.assertEquals(true,resSaveEvent);
	...
	public void ackEvent() {
		...
		Assert.assertEquals(true, checkAckEvent);
	...
	public void ackEventSingleAlarmLevelChange() {
		...
		Assert.assertEquals(true, checkAckEventSingleAlarmLevelChange);
	...
	public void insertUserEvents() {
		...
		Assert.assertEquals(true, checkInsertUserEvents);
	...
	public void getActiveEvents() {
		...
		Assert.assertEquals(true, checkLstAckEvents);
		...
		Assert.assertEquals(true,checkLstAckEventsNext);
	...
	public void getEventsForDataPoint() {
		...
		Assert.assertEquals(true, checkEventsForDataPoint);
	...
	public void insertEventComment(){
		...
		Assert.assertEquals(true, checkComment);
	...
	public void purgeEventsBefore() {
		...
		Assert.assertEquals(true, checkCountEvent);
	}
	...
	public void searchOldId() {
		...
		Assert.assertEquals(true, checkEvents);
	...
	public void searchRowCountStartRow() {
		...
		Assert.assertEquals(true, checkSearchRowCount);
		
		Assert.assertEquals(true, checkStartRow);
	...
	public void toggleSilence() {
		...
		Assert.assertEquals(true, events.get(0).isSilenced());
	}
