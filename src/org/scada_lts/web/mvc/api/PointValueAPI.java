...
public class PointValueAPI {
    ...
    public ResponseEntity<String> getValueId(@PathVariable("id") String id, HttpServletRequest request) {
        ...
        try {
            ...
            if (user != null) {
                DataPointVO dpvo = dataPointService.getDataPoint(Integer.parseInt(id));
                PointValueTime pvt = pointValueService.getLatestPointValue(dpvo.getId());
                String json = null;
                ObjectMapper mapper = new ObjectMapper();
     ...
     * @return
     */
    @RequestMapping(value = "/api/point_value/getValuesFromTime/id/{ts}/{id}", method = RequestMethod.GET)
    public ResponseEntity<String> getValuesFromTimeId(@PathVariable("ts") long ts, @PathVariable("id") String id, HttpServletRequest request) {

        LOG.info("/api/point_value/getValuesFromTime/id/{ts}/{xid} ts:" + ts + " id:" + id);
